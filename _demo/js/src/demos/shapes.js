...
(function(exports) {
    ...
    var order = function(ctx) {
        ...
        if (newElement !== undefined) { // got new element of ctx - add order
            ...
            maxOrder = newElement._meta.order;
        }
    ...
    var makeOperation = function(canvasCtx, obj, name) {
        return {
            ...
            fn: function(indicate) {
                if (typeof obj._meta !== 'undefined' && typeof obj._meta.type !== 'undefined') {
    ...
    var basicDefaults = function(canvasCtx, obj) {
        ...
        retObj.order = maxOrder;
        console.log('Created object order is: ' + retObj.order);
        return retObj;
    };
